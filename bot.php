...
";   
 ...
 "; 
  ...
  $arrPostData['messages'][0]['text'] = "
  AIS แบบเติมเงิน
   เติมเงินให้หมายเลขตัวเอง=>กด*120*รหัสบัตรเติมเงิน#โทร
   เติมเงินให้หมายเลขอื่นในระบบ1-2-Call=>กด*130*เบอร์1-2-Call*รหัสบัตรเติมเงิน#โทร
   เช็คยอดเงินและจำนวนวันคงเหลือ=>กด*121#โทร
   เช็คยอดเงินและวันหมดอายุของโบนัสค่าโทร=>กด*121*1#โทร
   เช็คโปรโมชันที่ใช้งานอยู่=>กด*777#โทร
   เช็คเบอร์โทรของตัวเอง=>กด*545#โทร
 ...
 "; 
  ...
  $arrPostData['messages'][0]['text'] = "
  AIS รายเดือน
   -เช็คยอดบริการระหว่างรอบบิล (บาท)=>*121*1#โทร
   -เช็คยอดคงเหลือรวมทุกแพ็กเกจ=>*121*21#โทร
   -เช็คยอดคงเหลือรายแพ็กเกจ=>*121*22#โทร
   -เช็คยอดค้างชำระ=>*121*3#โทร
   -เช็ควงเงินการใช้งาน=>*121*4#โทร
  ...
  $arrPostData['messages'][0]['text'] = "
DTAC แบบเติมเงิน
 -เช็คโปรโมชั่นปัจจุบัน(โปรฯ หลัก)=>กด *103*8#โทร
 -เช็คยอดเงินและวันคงเหลือ=>กด *101#โทร
 -เช็คยอดคงเหลือ โปรเสริมทุกแพ็กเกจ=>กด *101*1#โทร
 -เช็คอายุการใช้งานเบอร์แฮปปี้=>กด *102#โทร
 -เปิด Happy internet=>กด *104*71#โทร
 -ปิด Happy Internet=>กด *104*72#โทร
 -เช็กข้อมูลเกี่ยวกับการลงทะเบียน ซิมการ์ด=>กด *1002โทร
 -ส่งข้อมูลเพื่อขอลงทะเบียนซิมการ์ด=>กด *102*หมายเลขบัตรประชาชน 13 หลัก#โทร
  "; 
  ...
  $arrPostData['messages'][0]['text'] = "
  DTAC รายเดือน
   -เช็คแพ็กเกจปัจจุบัน=>กด *103*8#โทร
   -เช็คยอดค่าบริการค้างชำระและยอดค้างชำระระหว่างเดือน=>กด *121#โทร
   -เช็คยอดการใช้งานแพ็กหลักและแพ็กเสริม ของ Internet, SMS, MMS=>กด *121*1#โทร
   -เช็คยอดการใช้จำนวนนาทีระหว่างรอบบิล=>กด *121*2#โทร
   -เช็คยอดการใช้งานเฉพาะยอดค้างชำระค่าบริการเป็นบาท=>ด *121*3#โทร
   -เช็คยอดการใช้งานและยอดคงเหลือดีแทคโบนัสโทรฟรีระหว่างรอบบิลที่ใช้ไป=>กด *121*4#โทร
